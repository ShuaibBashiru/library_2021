...
<ul class="navbar-nav m-0 p-0 ms-auto">
        ...
        <li class="mb-2">
        <p class="pb-0 mb-1 align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#menus" aria-expanded="false">
        <i class="bi-list me-1"></i>    Menus
        <i class="bi-chevron-down  float-end"></i>
        </p>
        <div class="collapse" id="menus">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small" v-for="(d, index) in menus" :key="index">
...
export default {
        ...
        menus:[
        {"menuName":'itemcategory', 'menu_description':'Item category'},
        {"menuName":'additem', 'menu_description':'Add item'},
        {"menuName":'items', 'menu_description':'Item record(s)'},
        {"menuName":'requests', 'menu_description':'Requests'},
        ],
        mainMenu: [],
        admin_menu: [
